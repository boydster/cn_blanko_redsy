...
function template_main()
{
	...
	$normal_buttons = array(
		...
		'print' => array('text' => 'print', 'image' => 'print.gif', 'lang' => true, 'custom' => 'rel="nofollow" target="_blank"', 'url' => $scripturl . '?action=printpage;topic=' . $context['current_topic'] . '.0'),
	);
				...
				<div class="cat_bar">
					<h3 class="catbg">
						<span class="ie6_header floatleft"><a href="javascript:oQuickReply.swap();">
							<i class="fa fa-angle-down icon" id="quickReplyExpand" style="padding: 0 5px;"></i>
						</a>
	...
	echo '
				<script type="text/javascript" src="' . $settings['default_theme_url'] . '/scripts/topic.js?t=DEPLOY_TIMESTAMP"></script>
	...
	echo '
					if (\'XMLHttpRequest\' in window)
					{
						var oQuickModify = new QuickModify({
							...
							sTemplateSubjectEdit: ', JavaScriptEscape('<input type="text" style="width: 80%;" name="subject" value="%subject%" size="80" maxlength="80" tabindex="' . $context['tabindex']++ . '" class="input_text" />'), ',
